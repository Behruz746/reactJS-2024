...
import useInputValidatetion from "../hooks/UseInputValidatetion";
...
function Register() {
  const firstname = useInputValidatetion("");
  const lastname = useInputValidatetion("");
    ...
    <>
      ...
      >
        <div style={{ width: "100%", display: "flex", gap: "10px" }}>
          <input
            type="text"
            className={`form-control search-input mt-3 ${firstname.validateColor}`}
            value={firstname.value}
            onChange={firstname.onChange}
          />
          <input
            type="text"
            className={`form-control search-input mt-3 ${lastname.validateColor}`}
